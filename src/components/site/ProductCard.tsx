    ...
    >
      <div className="relative overflow-hidden bg-secondary aspect-[3/4]">
        ...
        <button
          ...
          className="absolute top-4 right-4 h-9 w-9 grid place-items-center rounded-full bg-background/90 backdrop-blur opacity-0 group-hover:opacity-100 transition-all duration-500 hover:text-accent"
        >
